...
-> exploratory testing -> playwright_test_generator -> cypress/e2e/<feature>/*.cy.js
-> Cypress execution -> playwright_test_healer when a test fails
```
...
Keep feature suites organized under `cypress/e2e/<feature>/` and plans under
